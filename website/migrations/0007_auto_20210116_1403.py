# Generated by Django 3.1.4 on 2021-01-16 14:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('website', '0006_auto_20210116_1359'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='appointments',
            name='choose_date',
            field=models.CharField(choices=[(1, 'Choose Your Date'), (2, 'Monday'), (3, 'Tuesday'), (4, 'Wednesday'), (5, 'Thursday'), (6, 'Friday')], default='Choose Your Date', max_length=50),
        ),
    ]
